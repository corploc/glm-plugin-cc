---
name: glm-prompting
description: Internal guidance for composing GLM prompts for coding, review, diagnosis, and research tasks inside the GLM Claude Code plugin
user-invocable: false
---

# GLM Prompting Guide for Coding Tasks

Reference document for writing effective prompts when delegating to GLM models via GLM CLI.
